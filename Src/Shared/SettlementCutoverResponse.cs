...
{
	/// <summary>
	/// Contains the pin pad response to a <see cref="SettlementCutoverRequest"/>.
	/// </summary>
	/// <seealso cref="SettlementCutoverRequest"/>
	public sealed class SettlementCutoverResponse : PosLinkResponseBase
	{
		...
		public SettlementCutoverResponse(IList<string> fieldValues) : base(fieldValues) { }

		/// <summary>
		/// Returns "SET".
		/// </summary>
		public override string MessageType { get { return ProtocolConstants.MessageType_SettlementCutover; } }

...
{
	/// <summary>
	/// Contains the pin pad response to a <see cref="SettlementEnquiryRequest"/>.
	/// </summary>
	/// <seealso cref="SettlementEnquiryRequest"/>
	public sealed class SettlementEnquiryResponse : PosLinkResponseBase
	{
		...
		public SettlementEnquiryResponse(IList<string> fieldValues) : base(fieldValues) { }

...
{
	/// <summary>
	/// Represents a request to begin a purchase that may subsequently have a tip added using manual entry of the card details.
	/// </summary>
	/// <seealso cref="PosLinkTransactionRequestBase"/>
	/// <seealso cref="TransactionResponseBase"/>
	/// <seealso cref="TipPreauthResponse"/>
	public class TipPreauthManualPanRequest : PosLinkTransactionRequestBase
	{
		/// <summary>
		/// Default constructor.
		/// </summary>
		public TipPreauthManualPanRequest() : base()
		{
		}
		...
		/// Returns "TPM".
		/// </summary>
		public override string RequestType { get { return ProtocolConstants.MessageType_TipPreauthManualPan;	}	}
		...
		/// </summary>
		/// <remarks>
		/// <para>Returns an empty string. Due to PCI-DSS compliance you can no longer provide card details from the PC, the pin pad will prompt for card details when it receives a TPM request.</para>
		/// </remarks>
		...
		/// <list type="bullet">
		/// <item><see cref="PurchaseAmount"/> is gerater than zero</item>

...
namespace Yort.Eftpos.Verifone.PosLink
{
	...
	public sealed class CashOnlyPurchaseResponseMessage : PurchaseResponseMessage
	{
		...
		public CashOnlyPurchaseResponseMessage(IList<string> fieldValues) : base(fieldValues) { }
